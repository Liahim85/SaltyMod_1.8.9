...
public class EntityRainmakerDust extends Entity {
    ...
    private int cloud = SaltConfig.cloudLevel.containsKey(this.worldObj.provider.getDimensionId()) ?
    		SaltConfig.cloudLevel.get(this.worldObj.provider.getDimensionId()) : 128;
